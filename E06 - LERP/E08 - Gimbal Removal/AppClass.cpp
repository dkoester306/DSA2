...
void Application::Display(void)
{
	...
	quaternion resultQuat = m_qOrientation* glm::angleAxis(glm::radians(1.0f), m_v3Rotation);
	quaternion inverse = glm::inverse(m_qOrientation);
	quaternion finalQuat = inverse * resultQuat;
	m_qOrientation += finalQuat;
	...
	m_pMesh->Render(m4Projection, m4View, ToMatrix4(finalQuat));
