...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	*/
	...
	first.push_back(this->m_m4ToWorld*vector4(0, 0, 1, 0));

	std::vector<vector3> second;
	second.push_back(a_pOther->m_m4ToWorld*vector4(1, 0, 0, 0));
	second.push_back(a_pOther->m_m4ToWorld*vector4(0, 1, 0, 0));
	second.push_back(a_pOther->m_m4ToWorld*vector4(0, 0, 1, 0));

	//there is no axis test that separates this two objects
	float rFirst, rSecond;	// the radii of the OBBs
	...
	t = vector3(glm::dot(t, first[0]), glm::dot(t, first[1]), glm::dot(t, first[2]));
