...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	{
		if (toggleShaderColor)
			toggleShaderColor = false;
		else
			toggleShaderColor = true;
	}
...
void AppClass::Display(void)
{
	...
	GLboolean ToggleColor = glGetUniformLocation(m_uShaderProgramID, "Toggle");
	glUniform1i(ToggleColor, toggleShaderColor);
